...
class AppConfigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_config" do
    assert_difference('AppConfig.count') do
      post app_configs_url, params: { app_config: { group: @app_config.group, name: @app_config.name, val: @app_config.val } }
    end
  ...
  test "should update app_config" do
    patch app_config_url(@app_config), params: { app_config: { group: @app_config.group, name: @app_config.name, config_val: @app_config.val } }
